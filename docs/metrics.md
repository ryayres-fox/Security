...
| --- | ---: | --- |
| Tracked files | **117** | files in `git ls-files`; untracked scratch excluded |
...
| Python code lines | **4324** | non-blank, non-comment |
| Comment + docstring lines | **826** | the reasoning, which is most of the point here |
