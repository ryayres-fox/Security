...
| --- | ---: | --- |
| Tracked files | **97** | files in `git ls-files`; untracked scratch excluded |
...
| Python code lines | **3939** | non-blank, non-comment |
| Comment + docstring lines | **733** | the reasoning, which is most of the point here |
