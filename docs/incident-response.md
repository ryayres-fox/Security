...
The diagram is generated by [`tools/render_diagrams.py`](../tools/render_diagrams.py)
and diffed in CI, like every diagram here — so it stays a living artifact, not a
screenshot of what a drawing tool showed one afternoon in 2017.
