...
And the layer the lists skip — [keeping a guardrail enforced on every session](docs/ai-baselines-across-sessions.md),
not just the one that set it up — is where a written policy becomes an enforced one.
